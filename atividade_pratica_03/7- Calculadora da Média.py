...
notas = list(map(float, input("Digite o valor: ").split()))

print(notas[0])

#Caldulo de média ponderada
nota_ponderada= ((notas[0]*2) + (notas[1]*3) + (notas[2]*4) + (notas[3]*1)) / 10

print(f"Media ponderada: {nota_ponderada}")

# PRIMEIRA ETAPA
if nota_ponderada < 5: print("Aluno reprovado.\n\n")
elif nota_ponderada >= 7: print("Aluno aprovado.\n\n")

# RECUPERAÇÃO
else:
    print("Aluno em exame \n")
    exame = float(input("Digite a nota do exame: "))
    resultado_final = (exame + nota_ponderada) / 2

    print(f"{nota_ponderada}")

    # RESULTADO FINAL
    if resultado_final >= 5: print("Aluno aprovado.\n\n")
