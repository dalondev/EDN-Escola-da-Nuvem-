...
n_funcionarios = input("Digite a quantidade de funcionarios: ")
horas_trabalhadas =  int(input("Digite a quantidade de horas trabalhadas: "))
salario =  int(input("Digite a o salario correspondente a uma hora: "))

print(f"O funcionario {n_funcionarios} recebe R$ {round(salario/horas_trabalhadas, 2)}")